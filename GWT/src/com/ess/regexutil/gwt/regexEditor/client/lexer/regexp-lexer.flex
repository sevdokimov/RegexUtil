...
{ESCAPE} "u" {ANY}{0,4}      { return RegExpTT.INVALID_UNICODE_ESCAPE_TOKEN; }
...
{ESCAPE} {XML_CLASS}         { if (xmlSchemaMode) return RegExpTT.CHAR_CLASS; else return RegExpTT.INVALID_CHARACTER_ESCAPE_TOKEN; }
...
{ESCAPE}  [:letter:]          { return RegExpTT.INVALID_CHARACTER_ESCAPE_TOKEN; }
...
{ESCAPE}                      { return RegExpTT.INVALID_CHARACTER_ESCAPE_TOKEN; }
...
<CLASS2> {
  ...
  [\n\b\t\r\f]          { return commentMode ? ITokenType.WHITE_SPACE : RegExpTT.ESC_CHARACTER; }
  {ANY}                 { return RegExpTT.CHARACTER; }
}
...
" "          { return commentMode ? ITokenType.WHITE_SPACE : RegExpTT.CHARACTER; }
[\n\b\t\r\f]   { return commentMode ? ITokenType.WHITE_SPACE : RegExpTT.CTRL_CHARACTER; }
