...
public abstract class Lexer {
   ...
   * @since IDEA 7
   */
  public abstract void start(String buffer, int startOffset, int endOffset, int initialState);

  public final void start(String buf, int start, int end) {
  ...
  public String getTokenSequence() {
    return getBufferSequence().substring(getTokenStart(), getTokenEnd());
  }

  public String getTokenText() {
    return getTokenSequence();
  }
  ...
  /**
   * Returns the token at the current position of the lexer or <code>0</code> if lexing is finished.
   *
   ...
   * @since IDEA 7
   */
  public abstract String getBufferSequence();
